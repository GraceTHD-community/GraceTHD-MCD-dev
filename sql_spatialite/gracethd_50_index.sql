...
DROP INDEX IF EXISTS nd_r1_code_idx; CREATE INDEX  nd_r1_code_idx ON t_noeud(nd_r1_code);
DROP INDEX IF EXISTS nd_r2_code_idx; CREATE INDEX  nd_r2_code_idx ON t_noeud(nd_r2_code);
DROP INDEX IF EXISTS nd_r3_code_idx; CREATE INDEX  nd_r3_code_idx ON t_noeud(nd_r3_code);
DROP INDEX IF EXISTS nd_r4_code_idx; CREATE INDEX  nd_r4_code_idx ON t_noeud(nd_r4_code);
...
DROP INDEX IF EXISTS cm_r1_code_idx; CREATE INDEX  cm_r1_code_idx ON t_cheminement(cm_r1_code);
DROP INDEX IF EXISTS cm_r2_code_idx; CREATE INDEX  cm_r2_code_idx ON t_cheminement(cm_r2_code);
DROP INDEX IF EXISTS cm_r3_code_idx; CREATE INDEX  cm_r3_code_idx ON t_cheminement(cm_r3_code);
DROP INDEX IF EXISTS cm_r4_code_idx; CREATE INDEX  cm_r4_code_idx ON t_cheminement(cm_r4_code);
...
DROP INDEX IF EXISTS cd_r1_code_idx; CREATE INDEX  cd_r1_code_idx ON t_conduite(cd_r1_code);
DROP INDEX IF EXISTS cd_r2_code_idx; CREATE INDEX  cd_r2_code_idx ON t_conduite(cd_r2_code);
DROP INDEX IF EXISTS cd_r3_code_idx; CREATE INDEX  cd_r3_code_idx ON t_conduite(cd_r3_code);
DROP INDEX IF EXISTS cd_r4_code_idx; CREATE INDEX  cd_r4_code_idx ON t_conduite(cd_r4_code);
...
DROP INDEX IF EXISTS cb_r1_code_idx; CREATE INDEX  cb_r1_code_idx ON t_cable(cb_r1_code);
DROP INDEX IF EXISTS cb_r2_code_idx; CREATE INDEX  cb_r2_code_idx ON t_cable(cb_r2_code);
DROP INDEX IF EXISTS cb_r3_code_idx; CREATE INDEX  cb_r3_code_idx ON t_cable(cb_r3_code);
DROP INDEX IF EXISTS cb_r4_code_idx; CREATE INDEX  cb_r4_code_idx ON t_cable(cb_r4_code);
