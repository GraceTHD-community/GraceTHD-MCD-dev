...
DROP TABLE IF EXISTS l_bool CASCADE;
...
DROP TABLE IF EXISTS l_ltech_typephy CASCADE;
...
DROP TABLE IF EXISTS l_position_usetype CASCADE;
...
CREATE TABLE l_bool(code VARCHAR(1), libelle VARCHAR(254), definition VARCHAR(254), CONSTRAINT "l_bool_pk" PRIMARY KEY (code));
...
CREATE TABLE l_position_usetype(code VARCHAR(2), libelle VARCHAR(254), definition VARCHAR(254), CONSTRAINT "l_position_usetype_pk" PRIMARY KEY (code));
...
CREATE TABLE l_technologie_type(code VARCHAR(3), libelle VARCHAR(254), definition VARCHAR(254), CONSTRAINT "l_technologie_type_pk" PRIMARY KEY (code));
